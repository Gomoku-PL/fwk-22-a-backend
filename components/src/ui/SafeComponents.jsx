...
export const SafeComment = ({
  ...
  const safeContent = allowHtml ? sanitizeHtml(content) : sanitizeText(content);
 ...
 */
export const SafeUserProfile = ({ username, displayName, bio, avatarUrl }) => {
  ...
  // Validate avatar URL
  const safeAvatarUrl =
    avatarUrl && avatarUrl.match(/^https?:\/\//)
      ? avatarUrl
      : "/default-avatar.png";
